      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
          ...
          <li class="nav-item active">
            <a href="pages/charts/adminchart.php" class="nav-link">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a href="passwordchange.php"class="dropdown-item">
                Change Password
              </a>
            <!--  <a class="dropdown-item">
                Check Inbox
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/forms/addstaff.php">
              <i class="menu-icon mdi mdi-backup-restore"></i>
              <span class="menu-title">Add Staff</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/forms/notify.php">
              <i class="menu-icon mdi mdi-backup-restore"></i>
              <span class="menu-title">Notify</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/tables/send_msg.php">
              <i class="menu-icon mdi mdi-backup-restore"></i>
              <span class="menu-title">Send Messages</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/charts/adminchart.php">
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Total Presentees</p>
